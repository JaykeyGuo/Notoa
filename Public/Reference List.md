...
- [x] [一年半前端跳槽面试经验](https://juejin.im/post/6844904095564709896)
- [ ] [阿里、有赞、滴滴、51信用卡](https://juejin.im/post/6844903928442667015#heading-130)
- [ ] [微信（前端Q）](https://www.ershicimi.com/p/fdf5c311a63cf13ea39c6f07dcff1e42)
- [ ] [字节](https://mp.weixin.qq.com/s?__biz=MzI0MzIyMDM5Ng==&mid=2649826757&idx=1&sn=fb5906190a4f51ce0167933c05d871e1&chksm=f175ef06c6026610849c8783055b8f7f7f18e6c6551e40505c31076638c83b9e56fc165fdfb3&scene=21#wechat_redirect)
...
- [x] [深入理解 webpack 文件打包机制](https://github.com/happylindz/blog/issues/6)
...
- [ ] [事件循环机制](https://github.com/i-want-offer/FE-Essay/blob/master/JS/%E4%BA%8B%E4%BB%B6%E5%BE%AA%E7%8E%AF.md)
...
- [x] [前端安全系列之一：如何防止XSS攻击？](https://juejin.im/post/6844903685122703367#heading-18)
- [x] [前端安全系列之二：如何防止CSRF攻击？](https://juejin.im/post/6844903689702866952)
- [x] [Web安全系列（四）：XSS 的防御](https://juejin.im/post/6844903684900388871#heading-5)
...
- [ ] [HTTP/2 push is tougher than I thought](HTTP/2 push is tougher than I thought)
- [x] [Async Defer — JavaScript Loading **Strategies**](https://medium.com/@raviroshan.talk/async-defer-javascript-loading-strategies-da489a0ba47e)
- [x] [小册-前端性能优化🔚](https://juejin.im/book/6844733750048210957/section/6844733750031417352)
...
CSS的匹配是从右到左的，所以在查找对应的元素的时候，如果有唯一的标示，匹配很快，但是有一些伪类的情况下，会花更多的时间。多层级的CSS匹配也是，需要从左到右一层一层的查找，每多一个条件就需要多查找一次。
...
- [ ] [Snowpack全攻略：从入门体验到源码解析](https://zhuanlan.zhihu.com/p/256482986)
- [ ] [CommonJS和ES6模块的区别](https://juejin.im/post/6844904067651600391)
- [x] [了解JavaScript模块系统的基础知识，并建立自己的库](https://www.yuque.com/docs/share/ffbb4fa7-ab00-4aa5-abb8-760cb09e806b)
...
1. [Vue虚拟列表](https://github.com/tangbc/vue-virtual-scroll-list)
...
- [x] [前端模块化的十年征程](https://zhuanlan.zhihu.com/p/265632724)
